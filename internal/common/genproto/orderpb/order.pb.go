...
// Protobuf 消息定义的 Go 结构体和序列化逻辑。里面有 CreateOrderRequest、GetOrderRequest、ItemWithQuantity、Item、Order 等类型，以及它们的 getter/元信息，供 gRPC 或普通 proto 序列化/反序列化使用。
package orderpb
...
const file_orderpb_order_proto_rawDesc = "" +
	...
	"\vUpdateOrder\x12\x0e.orderpb.Order\x1a\x16.google.protobuf.EmptyB?Z=github.com/getmelove/gorder2/internal/common/genproto/orderpbb\x06proto3"
